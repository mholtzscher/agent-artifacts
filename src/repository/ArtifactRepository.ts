...
export class ArtifactRepository extends Context.Service<
  ArtifactRepository,
  {
    readonly insertArtifact: (artifact: Artifact) => Effect.Effect<void, ArtifactRepositoryError>;
    readonly findArtifactBySlug: (slug: Slug) => Effect.Effect<Option.Option<Artifact>, ArtifactRepositoryError>;
    readonly slugExists: (slug: Slug) => Effect.Effect<boolean, ArtifactRepositoryError>;
