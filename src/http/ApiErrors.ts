...
export const ApiAuthErrors = [UnauthorizedError, ForbiddenError] as const;
export const ApiReadErrors = [ArtifactNotFoundError, ArtifactWithdrawnError, ServerError] as const;
